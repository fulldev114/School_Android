...
import com.cloudstream.cslink.teacher.FragmentStudentSetting;
import com.cloudstream.cslink.teacher.FragmentTeacher;
import com.cloudstream.cslink.teacher.TeacherSFOHomeActivity;
...
public class ParentHomeActivity extends Fragment implements View.OnClickListener {
                ...
                public void run() {
                    ...
                    if (messagelist != null) {
                        ...
                        for (HashMap<String, String> badgemap : messagelist) {
                            ...
                            Log.d("ParentHomeActivity", bean.badge + "......" + bean.kidid);
...
//            Intent i = new Intent(getActivity(), TeacherSFOHomeActivity.class);
//            startActivity(i);
        }
