...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            parent_no = intent.getStringExtra("parent_no");
    ...
    class SendRegistrationId extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            try {
                ...
                HttpPost postRequest = new HttpPost(ApplicationData.main_url + "device_reg.php");

                MultipartEntity reqEntity = new MultipartEntity(HttpMultipartMode.BROWSER_COMPATIBLE);
                reqEntity.addPart("userid", new StringBody(parent_id));
                reqEntity.addPart("device", new StringBody("ANDROID"));
                reqEntity.addPart("token", new StringBody(token));
                reqEntity.addPart("parent_no", new StringBody(parent_no));
