    ...
    private void findview(View rootView) {
        ...
        notification.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // ........................sharedpreferences.......................//
                SharedPreferences myPrefs = getActivity().getSharedPreferences("absentapp", Context.MODE_PRIVATE);
    ...
    private void change_lang() {
        ...
        if (myPrefs.getString("language", "nowrgian").equalsIgnoreCase("english")) {
            ...
            if (sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
                _english.setBackgroundDrawable(getResources().getDrawable(R.drawable.btn_cmd));
                nowrgian.setBackgroundDrawable(getResources().getDrawable(R.drawable.liner_white_border));
            } else {
                _english.setBackground(getResources().getDrawable(R.drawable.btn_cmd));
            ...
            if (sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
                ...
                nowrgian.setBackgroundDrawable(getResources().getDrawable(R.drawable.btn_cmd));
            } else {
                _english.setBackground(getResources().getDrawable(R.drawable.liner_white_border));
                nowrgian.setBackground(getResources().getDrawable(R.drawable.btn_cmd));
            }
        }
    }
