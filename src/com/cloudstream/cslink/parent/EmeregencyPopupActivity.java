...
public class EmeregencyPopupActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.emergency_popup_screen);
    ...
    public void onClick(View v) {
       ...
       /* Intent i = new Intent(EmeregencyPopupActivity.this,EmergencyAlertActivity.class);
        i.putExtra("selectedval",3);
        startActivity(i);*/
       /* if (Activityflag == 1) {
            Intent i = new Intent(EmeregencyPopupActivity.this, Pincode_activity.class);
            startActivity(i);
            finish();
        } else*/
        if (Activityflag == 2) {
