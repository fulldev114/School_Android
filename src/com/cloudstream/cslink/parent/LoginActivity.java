...
public class LoginActivity extends Activity {
    ...
    private void findview() {
        ...
        textRegister.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(LoginActivity.this, RegisterMainActivity.class);
                startActivity(in);
            }
        });
    }
    ...
    public void login(View v) {
        ...
        if (edtPhone.getText().toString().length() > 7) {
            ...
            login_url = ApplicationData.getlanguageAndApi(LoginActivity.this, ConstantApi.GET_VERIFY)
                    + "phone="
    ...
    private void getverify(String verify_url) {
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest(
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(LoginActivity.this, getResources().getString(R.string.msg_operation_error),
