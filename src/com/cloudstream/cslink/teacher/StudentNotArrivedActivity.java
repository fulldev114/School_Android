...
import com.adapter.teacher.StudentNotArrivedAdapter;
...
public class StudentNotArrivedActivity extends Activity /* implements AsyncTaskCompleteListener<String>*/ {
    Activity mActivity;

    ImageView mBack;
    ArrayList<StudentSFOBeans> mStudentArrayList = null;
    ListView mltActivities;
    StudentNotArrivedAdapter mStudentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTitle.setText(getResources().getText(R.string.not_arrived_title_low));
...
//                }
        ...
        mStudentAdapter = new StudentNotArrivedAdapter(StudentNotArrivedActivity.this, mStudentArrayList);
