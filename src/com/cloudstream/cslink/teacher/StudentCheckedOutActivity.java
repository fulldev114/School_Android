...
import com.adapter.teacher.StudentCheckedOutAdapter;
...
public class StudentCheckedOutActivity extends Activity /* implements AsyncTaskCompleteListener<String>*/ {
    Activity mActivity;

    ImageView mBack;
    ArrayList<StudentSFOBeans> mStudentArrayList = null;
    ListView mltActivities;
    StudentCheckedOutAdapter mStudentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTitle.setText(getResources().getText(R.string.checked_out_title_low));
...
//                }
        ...
        mStudentAdapter = new StudentCheckedOutAdapter(StudentCheckedOutActivity.this, mStudentArrayList);
