...
import com.adapter.teacher.SetCheckedInAdapter;
...
public class SetCheckedInActivity extends Activity /* implements AsyncTaskCompleteListener<String>*/ {
    Activity mActivity;

    ImageView mBack;
    ArrayList<StudentSFOBeans> mStudentArrayList = null;
    ListView mltActivities;
    SetCheckedInAdapter mStudentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTitle.setText(getResources().getText(R.string.checked_in_activity_title));
...
//                }
        ...
        mStudentAdapter = new SetCheckedInAdapter(SetCheckedInActivity.this, mStudentArrayList);
