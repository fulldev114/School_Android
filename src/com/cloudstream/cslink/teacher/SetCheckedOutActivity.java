...
import com.adapter.teacher.SetCheckedOutAdapter;
...
public class SetCheckedOutActivity extends Activity /* implements AsyncTaskCompleteListener<String>*/ {
    Activity mActivity;

    ImageView mBack;
    ArrayList<StudentSFOBeans> mStudentArrayList = null;
    ListView mltActivities;
    SetCheckedOutAdapter mStudentAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.set_checkedstatus_activity);
        ...
        txtTitle.setText(getResources().getText(R.string.checked_out_activity_title));
...
//                }
        ...
        mStudentAdapter = new SetCheckedOutAdapter(SetCheckedOutActivity.this, mStudentArrayList);
