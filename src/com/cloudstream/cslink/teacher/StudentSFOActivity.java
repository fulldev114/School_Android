...
import com.adapter.teacher.StudentSFOAdapter;
...
public class StudentSFOActivity extends Activity /* implements AsyncTaskCompleteListener<String>*/ {
    Activity mActivity;

    ImageView mBack;
    ArrayList<StudentSFOBeans> mStudentArrayList = null;
    ListView mltActivities;
    StudentSFOAdapter mStudentAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.student_sfo_activity);
        ...
        txtTitle.setTextColor(getResources().getColor(R.color.text_color_green));
        txtTitle.setText(getResources().getText(R.string.sfo_title));
...
//                }
        ...
        mStudentAdapter = new StudentSFOAdapter(StudentSFOActivity.this, mStudentArrayList);
        mltActivities.setAdapter(mStudentAdapter);
