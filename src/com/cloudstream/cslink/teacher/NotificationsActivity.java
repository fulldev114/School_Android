...
import com.adapter.teacher.NotificationsAdapter;
...
public class NotificationsActivity extends Activity /* implements AsyncTaskCompleteListener<String>*/ {
    Activity mActivity;

    ImageView mBack;
    ArrayList<StudentSFOBeans> mNotificationsArrayList = null;
    ListView mltNotifications;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_checkedout_activity);
        ...
        txtTitle.setText(getResources().getText(R.string.notifications_title));

        mltNotifications = (ListView) findViewById(R.id.lstStudent);
        mltNotifications.setOnItemClickListener(new OnItemClickListener() {
...
//                }
        ...
        mNotificationsArrayList = new ArrayList<StudentSFOBeans>();

        mNotificationAdapter = new NotificationsAdapter(NotificationsActivity.this, mNotificationsArrayList);
        mltNotifications.setAdapter(mNotificationAdapter);
