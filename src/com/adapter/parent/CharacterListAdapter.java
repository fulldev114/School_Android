...
public class CharacterListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, final ViewGroup parent) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.item_character_semester_header, parent, false);
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_character_mark, parent, false);
        ...
        if (childname.character_name != null && childname.character_name.length() > 0) {
