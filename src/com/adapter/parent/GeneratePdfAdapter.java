...
public class GeneratePdfAdapter extends BaseAdapter {
    ...
    public void updatenotify(Context context, ArrayList<Childbeans> markarray,
                             ArrayList<String> semester_name, ListView expand_report, Childbeans child_data,ReportCardActivity mActivity) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_mark_checkbox, parent, false);
        ...
        holderchild.grid_mark.setNumColumns(2);// gridView.setGravity(Gravity.CENTER);//
