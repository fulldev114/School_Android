...
public class StudentActivitiesAdapter extends BaseAdapter {
    ...
    public StudentActivitiesAdapter(Context c, ArrayList<StudentSFOBeans> studentList) {
        myc = c;
    ...
    static class ViewHolder {
        MyTextView_Signika_Regular mTxtName, mTxtClass, mTxtActivityName;
    ...
    public View getView(final int pos,  View convertview, ViewGroup arg2) {
        ...
        if (convertview == null) {
            convertview = li.inflate(R.layout.student_activities_list_item, null);

            holder = new ViewHolder();
            holder.mTxtActivityName = (MyTextView_Signika_Regular) convertview.findViewById(R.id.textView_activity);
