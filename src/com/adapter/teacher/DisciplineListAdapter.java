...
import com.cloudstream.cslink.teacher.DisciplineBehaveRepotActivity;
import com.cloudstream.cslink.R;

import java.lang.reflect.Array;
import java.util.ArrayList;

public class DisciplineListAdapter extends BaseAdapter {
    private boolean b=false;
    ArrayList<Childbeans> Date;
    ViewHolder holder;
    Context myc;

    public DisciplineListAdapter(Context c, ArrayList<Childbeans> list, boolean b) {
        myc = c;
        this.Date = list;
        this.b = b;
    }
    ...
    public void updaterecord(Context c,ArrayList<Childbeans> list,boolean b)
    {
        myc = c;
        this.Date = list;
        this.b = b;
    ...
    public View getView(final int pos, View convertview, ViewGroup parent) {
        ...
        if(b) {
            holder.txt_spin.setText(Date.get(pos).remarks_name);
           // holder.txt_spin.setGravity(Gravity.LEFT|Gravity.CENTER_VERTICAL);
        }
        else {
            holder.txt_spin.setText(Date.get(pos).descipline_name);
        }
    ...
    public View getDropDownView(int position, View convertView,
        ...
        if(b) {
            txt_spin.setText(Date.get(position).remarks_name);
            txt_spin.setGravity(Gravity.LEFT | Gravity.CENTER_VERTICAL);
        }
        else {
            txt_spin.setText(Date.get(position).descipline_name);
        //    txt_spin.setGravity(Gravity.RIGHT | Gravity.CENTER_VERTICAL);
        }
        return convertView;
    }
