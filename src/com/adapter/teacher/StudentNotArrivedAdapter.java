...
public class StudentNotArrivedAdapter extends BaseAdapter {
    ...
    public StudentNotArrivedAdapter(Context c, ArrayList<StudentSFOBeans> studentList) {
        myc = c;
    ...
    static class ViewHolder {
        MyTextView_Signika_Regular mTxtName, mTxtClass;
    ...
    public View getView(final int pos,  View convertview, ViewGroup arg2) {
        ...
        if (convertview == null) {
            convertview = li.inflate(R.layout.student_notarrived_list_item, null);
