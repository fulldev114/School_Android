...
public class SetCheckedOutAdapter extends BaseAdapter {
    ...
    public SetCheckedOutAdapter(Context c, ArrayList<StudentSFOBeans> studentList) {
        myc = c;
    ...
    public View getView(final int pos,  View convertview, ViewGroup arg2) {
        ...
        if (convertview == null) {
            convertview = li.inflate(R.layout.set_checkedstatus_list_item1, null);
