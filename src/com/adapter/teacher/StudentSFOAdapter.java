...
public class StudentSFOAdapter extends BaseAdapter {
    ...
    public StudentSFOAdapter(Context c, ArrayList<StudentSFOBeans> studentList) {
        myc = c;
    ...
    static class ViewHolder {
        MyTextView_Signika_Regular mTxtName, mTxtClass, mTxtDescription, mTxtStatus;
    ...
    public View getView(final int pos,  View convertview, ViewGroup arg2) {
        ...
        if (convertview == null) {
            convertview = li.inflate(R.layout.student_sfo_list_item, null);
            ...
            holder.mAddButton = (ImageView) convertview.findViewById(R.id.add_status);
