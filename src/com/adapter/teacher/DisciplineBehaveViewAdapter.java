...
public class DisciplineBehaveViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.adres_item_view_discipline, parent, false);
        ...
        if(childname.teacher_id.equalsIgnoreCase(_teacher_id))
        {
            holderchild.imgdel.setVisibility(View.VISIBLE);
        }
        else
        {
            holderchild.imgdel.setVisibility(View.GONE);
        }
        ...
        if (childname.date != null && childname.date.length() > 0) {
            holderchild.txt_date.setText(ApplicationData.convertToreportdate(childname.date, context));
        }
        ...
        if (childname.image != null && childname.image.length() > 0) {
            ApplicationData.setProfileImg(holderchild.img_profile, ApplicationData.web_server_url + "/uploads/" + childname.image, context);
        }
        else
        {
            holderchild.img_profile.setImageResource(R.drawable.cslink_avatar_unknown);
        }
...
/*
    public void showDetailDialog(final MarkBean markBean, final int position, final int parentposition) {
        ...
        dlg.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));//context.getResources().getColor(R.color.dark_blue)));
        ...
        txt_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((ReportCardActivity) context).calluploadpdf(context, subtopdfarray, child_data, studentlist);
