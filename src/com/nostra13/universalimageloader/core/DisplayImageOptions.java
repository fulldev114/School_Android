...
public final class DisplayImageOptions {
	...
	public  static int     IMAGE_TYPE_AVATAR = 1;
	public  static int     IMAGE_TYPE_AVATAR_MEDIUM = 2;
	public  static int     IMAGE_TYPE_AVATAR_BIG = 3;
	
	public  static int	   IMAGE_TYPE_PICA_STAR_AVATAR = 5;
	public  static int     IMAGE_TYPE_PICA_STAR_COVER = 6;
	
	public  static int     IMAGE_TYPE_EVENT_GIFT_IMAGE = 7;
	...
	public static class Builder {
		...
		public Builder setImageType(int aImageType){
